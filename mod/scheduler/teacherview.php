...
$table_name = "mdl_scheduler_slots";
$teacher_id = $USER->id;

$conn = new mysqli($server_name, $mysql_username, $mysql_password, $db_Name);

$sql = "SELECT duration FROM " . $table_name . " WHERE teacherid = " .  $teacher_id . ";";
...
if ($result->num_rows > 0) {
    ...
    echo "Your Total number of hours is " . $sum;
}else{
    echo "You dont have any hours";
}
